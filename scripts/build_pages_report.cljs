...
(defn build-report []
  (let [cfd (solver/solve {:solver {:kind :cfd}
        ...
        html (str "<!doctype html><html lang=\"en\"><head><meta charset=\"utf-8\">"
                  ...
                  "<section class=\"kami-stage\"><canvas id=\"kami-webgpu-canvas\" aria-label=\"ClojureScript direct WebGPU renderer\"></canvas><div class=\"kami-stage-copy\"><div id=\"kami-runtime-status\">Loading ClojureScript WebGPU…</div><div id=\"kami-scene-name\">CFD · flow / combustion</div><hr><div>CLJS frames: <span id=\"kami-cljs-frames\">0</span></div><div>WebGPU draws: <span id=\"kami-webgpu-draws\">0</span></div></div></section><div class=\"kami-scenes\"><button class=\"active\" data-kami-scene=\"0\">CFD</button><button data-kami-scene=\"1\">FEM</button><button data-kami-scene=\"2\">Process</button><button data-kami-scene=\"3\">Materials</button><button data-kami-scene=\"4\">EM</button><button data-kami-scene=\"5\">Production</button><button data-kami-scene=\"6\">Sod FVM</button><button data-kami-scene=\"7\">RANS k–ε</button><button data-kami-scene=\"8\">Adaptive Mesh</button><button data-kami-scene=\"9\">Thermo-Mechanical</button><button data-kami-scene=\"10\">EM FEM</button><button data-kami-scene=\"11\">3D Contact</button><button data-kami-scene=\"12\">Fracture</button><button data-kami-scene=\"13\">MPI Halo</button><button data-kami-scene=\"14\">Mesh Quality</button></div>"
                  ...
                  (html-escape json) "</pre><script>window.__KAMI_CAE_METRICS__=" json ";</script><script src=\"./kami-cae-webgpu.js\"></script></body></html>")]
